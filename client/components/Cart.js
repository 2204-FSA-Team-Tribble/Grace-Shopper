      ...
      <div className='container'>
        <div className='table-responsive'>
          <div className='row admin-top'>
              <div className='col'><h1>Shopping Cart</h1></div>
          </div>
          ...
          {products.map((item, index) => {
            return (
                <tr className="cart-item" key={index}>
                  <td>
                    <img className="cart-product-picture" src={`${item.product.image}`} />
                  </td>
                  <td>
                    {item.product.name}
                  </td>
                  ...
                  <td>
                    <button className="btn btn-sm btn-block btn-danger" type="button" onClick={() => this.props.removeProduct(item.id)}>Remove</button>
                  </td>
                  <td>
          ...
          <div className='checkout-total'>
            ...
            <button className="btn btn-md btn-block btn-success" type="button">Proceed to checkout</button>
          </div>
        </div>
      </div>
    )
